...
os.environ['CUDA_VIDIBLE_DEVICES']="3"
# ids = [0,1]
...
parser.add_argument('--model_write_ckpt',
                    default="./ckpts/my_model", type=none_or_str,
                    action='store',)
...
parser.add_argument('--lm_emb_path',
                    default='./wv/albert.CoNLL04_with_heads.pkl', type=str,
                    action='store',)
...
trainer.train_model(args=args)#models/base.py
