...
parser.add_argument('--model_name',
                    default='allenai/scibert_scivocab_uncased',  # 'albert-xxlarge-v1,studio-ousia/luke-base',allenai/scibert_scivocab_uncased
                    action='store', )

parser.add_argument('--save_path',
                    default='../wv/scibert_all.scierc_with_heads.pkl',
                    action='store', )
            ...
            for sentence_index, sentence in enumerate(sentences):
                ...
                for token in sentence:
                    ...
                    if self.pooling_operation == "first":
                        ...
                        if feature.token_subtoken_count[token.idx] == 0:  # 如果是个独立的词
                            ...
                            #     mean = torch.randn(4096)#.to(device)
                            # else:
...
if args.layers == 'mean':
    embedding = BertEmbeddingsWithHeads(args.model_name, layers='-1,-2,-3,-4', use_scalar_mix=True,
