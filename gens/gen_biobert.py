...
parser.add_argument('--model_name',
                    default='dmis-lab/biobert-large-cased-v1.1',  # 'albert-xxlarge-v1,studio-ousia/luke-base',dmis-lab/biobert-large-cased-v1.1
                    action='store', )

parser.add_argument('--save_path',
                    default='../wv/biorel/biobert.biorel_org_with_heads.pkl',
                    action='store', )
